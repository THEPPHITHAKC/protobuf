...
/**
 * Stub for GeneratedMessageV3 wrapping GeneratedMessage for compatibility with older gencode. This
 * class is deprecated, and slated for removal in the next Java breaking change (5.x in 2025 Q1).
 * Users should update gencode to >= 4.26.x which uses GeneratedMessage instead of
 * GeneratedMessageV3.
 */
@Deprecated
